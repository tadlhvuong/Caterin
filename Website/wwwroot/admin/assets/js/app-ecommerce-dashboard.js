...
(function () {
    ...
    var dt_invoice = dt_invoice_table.DataTable({
      ...
      order: [[1, 'desc']],
        ...
        dom:
          ...
          '<"col-12 col-md-5 d-flex align-items-center justify-md-content-start justify-content-center"l<"dt-action-buttons text-xl-end text-lg-start text-md-end text-start"B>>' +
          '<"col-12 col-md-5 d-flex justify-content-center flex-column flex-md-row"f<"invoice_status m-2">>' +
          '>t' +
          '<"row m-2 d-flex align-items-center "' +
      ...
      buttons: [
        {
          text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block">Create Invoice</span>',
  ...
  // ? setTimeout used for multilingual table initialization
    setTimeout(() => {
        $('.dt-length').addClass('dt-length d-flex align-items-center justify-between justify-content-start gap-2 m-2');
        $('.dt-search').addClass('dt-search d-flex align-items-center m-2');
        $('.dt-search .form-control').removeClass('form-control-sm');
        $('.dt-length .form-select').removeClass('form-select-sm');
        $('.pagination').addClass('pagination m-0');
  }, 300);
})();
