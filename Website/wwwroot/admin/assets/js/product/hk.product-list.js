...
$(function () {
  ...
  // Variable declaration for table
        ...
        var dt_products = dt_product_table.DataTable({
            ...
            columnDefs: [
...

                {
                    ...
                    checkboxes: {
                        selectAllRender: '<input type="checkbox" id="select-all-products" class="form-check-input">'
                    }
                },
...

                {
                    ...
                    render: function (data, type, full) {
                        ...
                        var category = full.categoryName;
...

                {
                    ...
                    render: function (data, type, full) {
                        ...
                        return (
                            ...
                            'class="dropdown-item product-suspend" ' +
                            'data-id="' + full.id + '">' +
                            suspendText +
                            '</a>' +
            ...
            buttons: [
                {
                    text:
                        ...
                        '<span class="d-none d-sm-inline-block">Thêm sản phẩm</span>',
            ...
            headerCallback: function (thead) {
                ...
                if (!$header.find('#select-all-products').length) {
                    $header.html(
                        '<input type="checkbox" ' +
            ...
            initComplete: function () {
                ...
                $.get('/admin/product/statuses', function (statuses) {
                    ...
                    select.appendTo('.product_status');
    ...
    const $checkboxes =
        $('.datatables-products tbody .dt-checkboxes');
...
$('.datatables-products tbody').on(
  ...
  $('.datatables-products tbody').on('click', '.delete-record', function () {
    ...
    $('.datatables-products tbody').on('change', '.dt-checkboxes', function () {
        const total = $('.datatables-products tbody .dt-checkboxes').length;
        const checked = $('.datatables-products tbody .dt-checkboxes:checked').length;
    ...
    $(document).on('click', '.product-suspend', function () {
        const token = $('#antiForgeryForm input[name="__RequestVerificationToken"]').val();
        console.log('new');
        const id = $(this).data('id');

        $.ajax({
            url: '/admin/product/toggle-suspend',
            type: 'POST',
